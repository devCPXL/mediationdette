...
MetronicApp.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('ListMazout', {
            ...
            templateUrl: "views/energie/listMazout.html",
            data: {pageTitle: 'List Mazout', pageSubTitle: 'sous Titre List Mazout'},
        ...
        // List Dossier Mazout
        .state('ListMazoutExtra', {
            url: "/energie/ListMazout/extra",
            templateUrl: "views/energie/extra_mazout.html",
            data: {pageTitle: 'ALLOCATION MAZOUT :', pageSubTitle: 'FONDS MAZOUT'},
            controller: "ExtraMazoutController",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'ui.select',
